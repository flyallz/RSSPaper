...
解压 `JournalRadar-Universal-v1.2.1-Mac-arm64.zip`，将 `JournalRadar.app` 放入“应用程序”并打开。适用于 Apple 芯片的 macOS 13 或更新版本。首次打开未公证的应用时，macOS 可能要求你在“系统设置 → 隐私与安全性”中决定是否允许打开。
